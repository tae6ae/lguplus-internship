...
digraph {
        ...
        subgraph "root" {
                ...
                "[root] aws_default_security_group.security_group_service (expand)" [label = "aws_default_security_group.security_group_service", shape = "box"]
                ...
                "[root] aws_security_group.security_group_lb (expand)" [label = "aws_security_group.security_group_lb", shape = "box"]
                ...
                "[root] aws_default_security_group.security_group_service (expand)" -> "[root] aws_vpc.vpc-01 (expand)"
                "[root] aws_internet_gateway.igw (expand)" -> "[root] aws_vpc.vpc-01 (expand)"
                "[root] aws_lb.lb (expand)" -> "[root] aws_security_group.security_group_lb (expand)"
                ...
                "[root] aws_security_group.security_group_lb (expand)" -> "[root] aws_vpc.vpc-01 (expand)"                "[root] aws_subnet.subnet-01 (expand)" -> "[root] aws_vpc.vpc-01 (expand)"
                ...
                "[root] provider[\"registry.terraform.io/hashicorp/aws\"] (close)" -> "[root] aws_default_security_group.security_group_service (expand)"
